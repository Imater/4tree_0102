    ...
    return {
      ...
      link: function(scope, el, attr, ngModel) {
        ...
        renderDate = function(el, viewValue) {
          ...
          el.find('.year').val(date.getFullYear() || "");
          el.find('.hours').val(date.getHours() || "");
          return el.find('.minutes').val(date.getMinutes() || "");
        };
        ...
        parseDateFromInput = function(el) {
          var day, found_month_key, hours, minutes, month, substr_month, year;
          day = el.find('.day').val();
          ...
          year = parseInt(year);
          return new Date(year, found_month_key, day, hours, minutes);
        };
        ...
        return el.on('keydown', 'input', function(e) {
          ...
          if (e.keyCode === params.key_code.up) {
            ...
            if ($(this).hasClass('hours')) {
              dt = new Date(date);
              scope.$apply(function() {
                return ngModel.$setViewValue(new Date(dt.setHours(dt.getHours() + 1)));
              });
            }
            if ($(this).hasClass('minutes')) {
              dt = new Date(date);
              scope.$apply(function() {
                return ngModel.$setViewValue(new Date(dt.setMinutes(dt.getMinutes() + 1)));
              });
            }
          }
...
//# sourceMappingURL=dir_datetime.map
