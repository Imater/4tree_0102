...
(function() {
  angular.module("4treeApp").service('diffApi', [
    'db_tree', function(db_tree) {
      return {
        diff: function(old, new_, time) {
          var changes, compare, delCheck;
        ...
        logJson: function(title, data, compact) {
          ...
          return console.info('[' + hours + ':' + minutes + ':' + seconds + '] ' + title + ' = ' + JSON.stringify(data, false, !compact ? '  ' : void 0));
        }
      };
    }
  ]);
