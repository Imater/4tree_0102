angular.module("4treeApp").service 'syncApi', ['$translate', 'db_tree', '$q', '$http', 'oAuth2Api', 'diffApi',
                                               '$rootScope', '$timeout', '$socket',
  ($translate, db_tree, $q, $http, oAuth2Api, diffApi, $rootScope, $timeout, $socket) ->
    autosync_on: true
    sync_journal: {}
    ...
    jsStartSync: ()->
      ...
      _.each @sync_journal, (sync_one, key)->
        found = _.find db_tree._db.tree, (el)->
          el._id == key
