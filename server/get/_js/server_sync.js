...
(function() {
  var $, Diff, JSON_stringify, Text, async, jsondiffpatch, logJson, mongoose, sync, winston, _;
  ...
  exports.get = function(req, res) {
    ...
    return exports.fullSyncUniversal(req, res).then(function(data_to_client) {
      ...
      return winston.profile('Время исполнения синхронизации');
    });
  };
        ...
        if (confirm_count > 0) {
          ...
          if (clients) {
            async.each(Object.keys(clients), function(client_i, callback3) {
              ...
              return winston.info('info sended by socket...');
            });
          }
        }
        return winston.info('SYNC ENDED!!!');
      });
    }
    return dfd.promise();
  };
