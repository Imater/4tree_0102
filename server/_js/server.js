...
(function() {
  var $, Imap, MongoClient, OAuthUsersModel, Pool, RedisStore, Task, Tree, allWorkers, app, async, cluster, db, diff, elasticsearch, es_client, express, fs, http, i, imap, io, logJson, mail_service, md5, model, mongoose, mysql, notifier, notifier_instance, numCPUs, oauthserver, publisher, redis, redis_client, search, server, subscriber, uristring, users_connection, worker, workers, _, _i;
