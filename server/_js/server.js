...
(function() {
  var $, Imap, MongoClient, OAuthUsersModel, Pool, RedisStore, Tree, allWorkers, app, async, cluster, db, diff, express, fs, http, i, imap, io, logJson, mail_service, md5, model, mongoose, mysql, notifier, notifier_instance, numCPUs, oauthserver, publisher, redis, redis_client, server, subscriber, test_tmp, uristring, worker, workers, _, _i;
