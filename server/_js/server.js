...
(function() {
  var $, MongoClient, Pool, RedisStore, Tree, allWorkers, app, async, cluster, db, express, http, i, io, md5, model, mongoose, mysql, numCPUs, oauthserver, publisher, redis, redis_client, server, subscriber, test_tmp, uristring, worker, workers, _, _i;
