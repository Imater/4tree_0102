...
(function() {
  var $, MongoClient, Pool, RedisStore, allWorkers, app, async, cluster, count, db, express, http, i, io, md5, mysql, numCPUs, publisher, redis, redis_client, server, subscriber, worker, workers, _, _i;
