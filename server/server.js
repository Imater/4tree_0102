...
(function() {
  var $, Pool, RedisStore, allWorkers, app, cluster, express, fs, http, i, io, md5, mysql, numCPUs, publisher, qs, redis, redis_client, server, subscriber, worker, workers, _, _i;
  ...
  if (cluster.isMaster) {
    ...
    app.configure(function() {
      ...
      return app.use(function(req, res, next) {
        ...
        } else if (/bower_components/g.test(req.url) && !(/localhost/.test(req.headers.host))) {
